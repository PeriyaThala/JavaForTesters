...
//fulfilling second important thing

import MissionTest1.Beginner3;
...
public class Class20 {
	...
	public static void main(String[] args) {
		 ...
		 * provides access specifier protection -> restrict access to certain classes
		 ...
		 * 2. To use use method of different class of different package -> you have to import that class
		 */
